import{av as O,aw as R,ax as Z,O as j,ag as F,af as G,ay as K,f as $,b as t,p as V,a as b,y as m,g as a,az as J,s as i,B as y,U as w,d as X,A as I,a5 as Y,a7 as aa}from"./iframe-D_iF5c85.js";import{c as ea,d as ta}from"./create-runtime-stories-cJTTi5Jk.js";import{L as ra}from"./LoadingWrapper-BtRosSEG.js";import{D as S}from"./DatawrapperIframe-CELrtceV.js";import{B as da}from"./BasicDropdown-BV9-kScM.js";import{B as D}from"./Button-BaoQD_bw.js";import"./style-CNURdi_Z.js";import"./attributes-q36Eg1F8.js";import"./lifecycle-DPT9lhMs.js";import"./urbanColors-BkxYcPwH.js";import"./LogoUrbanAnimated-CMdd7yyu.js";import"./attributes-BlXGg7Yy.js";import"./class-B9SFUanI.js";import"./each-B1oKFb8M.js";import"./misc-B3v2RBLd.js";import"./this-BBCWgB8B.js";function na(r,f,B){var k=r,g=K,L,u=O()?R:Z;j(()=>{u(g,g=f())&&(L&&F(L),L=G(()=>B(k)))})}var oa=$("<div></div>");function T(r){var f=oa();t(r,f)}T.__docgen={data:[],name:"Placeholder.svelte"};const sa={title:"Examples/Stories/Datawrapper Switching",component:T},{Story:q}=ta(),U=[{value:"AHpJL",label:"Chart #1",ariaLabel:"Quis id magna ut esse qui nostrud magna."},{value:"91Q0t",label:"Chart #2",ariaLabel:"Quis id magna ut esse qui nostrud magna."},{value:"eaD2D",label:"Chart #3",ariaLabel:"Quis id magna ut esse qui nostrud magna."}],la=[{value:"Toh1S",label:"Chart #1",ariaLabel:"Quis id magna ut esse qui nostrud magna."},{value:"rgLU1",label:"Chart #2",ariaLabel:"Quis id magna ut esse qui nostrud magna."}];let C=J("AHpJL"),h=I(()=>U.find(r=>r.value===a(C))),M=J("Toh1S"),H=I(()=>la.find(r=>r.value===a(M)));var ia=$("<!> <!>",1),ua=$("<!> <!> <!> <!>",1),pa=$("<!> <!> <!>",1),ca=$("<!> <!> <!>",1);function W(r,f){V(f,!0);var B=ca(),k=b(B);q(k,{name:"Dropdown",asChild:!0,source:`
<script>
...
{/if}`}}}),t(r,B),X()}W.__docgen={data:[],name:"DatawrapperSwitching.stories.svelte"};const x=ea(W,sa),Qa=["Dropdown","Buttons","Loading"],ya={...x.Dropdown,tags:["svelte-csf-v5"]},Sa={...x.Buttons,tags:["svelte-csf-v5"]},qa={...x.Loading,tags:["svelte-csf-v5"]};export{Sa as Buttons,ya as Dropdown,qa as Loading,Qa as __namedExportsOrder,sa as default};

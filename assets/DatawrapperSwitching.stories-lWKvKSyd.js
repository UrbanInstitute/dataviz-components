import{av as O,aw as R,ax as Z,N as j,ag as F,af as G,ay as K,f as $,b as t,p as V,a as b,y as m,g as a,az as H,s as i,A as y,T as w,d as X,a8 as I,a4 as Y,a6 as aa}from"./iframe-DyWuGZgA.js";import{c as ea,d as ta}from"./create-runtime-stories-fMtdXIcw.js";import{L as ra}from"./LoadingWrapper-BI-ohP_K.js";import{D as S}from"./DatawrapperIframe-Cyw-tDub.js";import{B as da}from"./BasicDropdown-eXa5D3ez.js";import{B as D}from"./Button-BJitk2E-.js";import"./style-CNURdi_Z.js";import"./attributes-q36Eg1F8.js";import"./lifecycle-BV4teSqg.js";import"./urbanColors-BkxYcPwH.js";import"./LogoUrbanAnimated-DxtxhSxh.js";import"./attributes-DesoiSbl.js";import"./class-B9SFUanI.js";import"./each-BdKYQQNe.js";import"./misc-ayKpQMgR.js";import"./this-D8r0RiQE.js";function na(r,f,B){var k=r,g=K,L,u=O()?R:Z;j(()=>{u(g,g=f())&&(L&&F(L),L=G(()=>B(k)))})}var oa=$("<div></div>");function J(r){var f=oa();t(r,f)}J.__docgen={data:[],name:"Placeholder.svelte"};const sa={title:"Examples/Stories/Datawrapper Switching",component:J},{Story:q}=ta(),W=[{value:"AHpJL",label:"Chart #1",ariaLabel:"Quis id magna ut esse qui nostrud magna."},{value:"91Q0t",label:"Chart #2",ariaLabel:"Quis id magna ut esse qui nostrud magna."},{value:"eaD2D",label:"Chart #3",ariaLabel:"Quis id magna ut esse qui nostrud magna."}],la=[{value:"Toh1S",label:"Chart #1",ariaLabel:"Quis id magna ut esse qui nostrud magna."},{value:"rgLU1",label:"Chart #2",ariaLabel:"Quis id magna ut esse qui nostrud magna."}];let C=H("AHpJL"),h=I(()=>W.find(r=>r.value===a(C))),M=H("Toh1S"),T=I(()=>la.find(r=>r.value===a(M)));var ia=$("<!> <!>",1),ua=$("<!> <!> <!> <!>",1),pa=$("<!> <!> <!>",1),ca=$("<!> <!> <!>",1);function U(r,f){V(f,!0);var B=ca(),k=b(B);q(k,{name:"Dropdown",asChild:!0,source:`
<script>

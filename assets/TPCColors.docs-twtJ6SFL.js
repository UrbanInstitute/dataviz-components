import{j as e}from"./iframe-Dwb2GjWe.js";import{useMDXComponents as c}from"./index-CwyO-9iH.js";import{M as p,e as l,f as n}from"./blocks-ZcOBDzX8.js";import"./preload-helper-Dp1pzeXC.js";const j="#174a7c",a="#008bb0",i="#60a1b6",d="#95c0cf",u="#cae0e7",h="#1d5669",b="#0e2b35",m="#f0573e",g="#bcbec0",x="#000000",f="#fcb64b";function y(){return[u,d,i,a,h,b].slice()}const t={blue_dark:j,blue:a,blue_shade_light:i,blue_shade_lighter:d,blue_shade_lightest:u,blue_shade_dark:h,blue_shade_darker:b,orange:m,gray:g,black:x,yellow:f,getBlues:y};function r(o){const s={a:"a",code:"code",h1:"h1",h2:"h2",img:"img",p:"p",pre:"pre",...c(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(p,{title:"utils/tpcColors"}),`
...
tpcColors.getBlues();
`})})]})}function M(o={}){const{wrapper:s}={...c(),...o.components};return s?e.jsx(s,{...o,children:e.jsx(r,{...o})}):r(o)}export{M as default};

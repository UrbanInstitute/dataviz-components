...
`]}),`
`,e.jsxs(n.p,{children:["See the ",e.jsx(n.a,{href:"https://github.com/UrbanInstitute/dataviz-components/blob/main/docs/runes-breaking-changes.md",rel:"nofollow",children:"breaking changes log"})," for complete migration examples."]})]})}function l(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{l as default};

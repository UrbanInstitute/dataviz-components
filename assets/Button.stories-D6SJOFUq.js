import{p as j,f as q,a as K,Z as o,b as r,s as l,g as c,h as d,d as Y}from"./iframe-BcferWuU.js";import{i as Z}from"./lifecycle-BcSUtK95.js";import{B as E}from"./Button-CeUI2gWw.js";import{I as u}from"./IconDownload-Dfnoen69.js";import{c as A,d as F}from"./create-runtime-stories-CHM6HO4D.js";import"./attributes-1snxx-6i.js";import"./attributes-q36Eg1F8.js";import"./class-B9SFUanI.js";import"./style-CNURdi_Z.js";import"./this-XyIzL1DC.js";const G='Basic HTML Button adhering to Urban styles.\n\n```js\nimport { Button } from "@urbaninstitute/dataviz-components";\n```\n',{within:J,expect:v,fn:_}=__STORYBOOK_MODULE_TEST__,N={title:"Components/Button",component:E,tags:["autodocs"],argTypes:{variant:{default:"primary",options:["primary","primary-black","secondary","secondary-black","tertiary"],control:"select"},size:{default:"standard",options:["standard","small"],control:"select"}},args:{onClick:_(),onMouseenter:_(),onMouseleave:_()},parameters:{docs:{description:{component:G}},githubLink:{url:"/Button/Button.svelte"}}},{Story:s}=F();var Q=q("<!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!> <!>",1);function O(H,R){j(R,!1),Z();var B=Q(),y=K(B);s(y,{name:"primary",children:(a,e)=>{var t=o("Button text");r(a,t)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Button text
</Button>`}}});var $=l(y,2);s($,{name:"primary with event listeners",play:async({canvasElement:a,args:e,userEvent:t})=>{const i=J(a).getByRole("button");await t.click(i),await v(e.onClick).toHaveBeenCalled(),await t.hover(i),await v(e.onMouseenter).toHaveBeenCalled(),await t.unhover(i),await v(e.onMouseleave).toHaveBeenCalled()},children:(a,e)=>{var t=o("Button text");r(a,t)},$$slots:{default:!0},parameters:{__svelteCsf:{rawCode:`<Button {...args}>
  Button text
...
<IconDownload size={16} fill={iconColor} />
  ...
  Button text
   ...
   <Button variant="tertiary">Button text<svelte:fragment slot="icon" let:iconColor>
	<IconDownload size={16} fill={iconColor} />
</svelte:fragment>
</Button>

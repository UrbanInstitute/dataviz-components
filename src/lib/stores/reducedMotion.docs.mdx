...
**Note:** This module has been deprecated. It remains available for support, but may be removed in a future version. This functionality has been superceded by the [matchMedia](/docs/stores-matchmedia--docs) module .

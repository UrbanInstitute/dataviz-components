...
<svg
  ...
  ><g id="Layer_1-2"
    ><path fill={darkColor} d="M73.58,.1h2.32V6.48h-2.32V.1Z" /><path
      fill={darkColor}
    ...
    /><path
      fill={darkColor}
      d="M96.95,4.19l.12,.09c.42,.32,.91,.58,1.45,.58,.23,0,.59-.09,.59-.38s-.3-.31-.52-.36l-.47-.08c-.9-.16-1.67-.69-1.67-1.69,0-1.51,1.38-2.36,2.76-2.36,.73,0,1.39,.18,2.02,.56l-.63,1.63c-.4-.27-.85-.48-1.34-.48-.2,0-.5,.08-.5,.34,0,.24,.29,.27,.46,.31l.52,.12c.98,.22,1.69,.74,1.69,1.83,0,1.52-1.39,2.27-2.76,2.27-.8,0-1.73-.22-2.45-.58l.71-1.8Z"
    /><path
      fill={darkColor}
      d="M108.63,.1h4.87V2.17l-1.28-.06V6.48h-2.32V2.11l-1.28,.06V.1Z"
    /><path fill={darkColor} d="M121.58,.1h2.32V6.48h-2.32V.1Z" /><path
      fill={accentColor}
    ...
    /><path
      fill={darkColor}
      d="M132.13,.1h4.87V2.17l-1.28-.06V6.48h-2.32V2.11l-1.28,.06V.1Z"
    /><path
      fill={darkColor}
      d="M149.93,.1V3.87c0,1.86-1.17,2.71-2.95,2.71s-2.95-.85-2.95-2.71V.1h2.32V3.65c0,.5,.02,.94,.63,.94s.63-.44,.63-.94V.1h2.32Z"
    /><path
      fill={darkColor}
      d="M156.13,.1h4.87V2.17l-1.28-.06V6.48h-2.32V2.11l-1.28,.06V.1Z"
    /><path
      fill={darkColor}
